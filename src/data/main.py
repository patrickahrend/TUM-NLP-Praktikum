...
australinen_excel = pd.ExcelFile("../data/Addition_Australia_data_small_use_case_3_hire_employee.xlsx")
...
process_matching_data(australinen_excel, "training_matching", "../data/hiring_employee.csv")
